...
public class EbankingBackendApplication {
    ...
    @Bean
    CommandLineRunner commandLineRunner(/*BankAccountRepository bankAccountRepository*/ BankAccountService bankAccountService){
        return args -> {
             //bankService.Consulter();
            Stream.of("Nezha", "Zainab", "Redwane").forEach(name->{
            ...
            /*BankAccount bankAccount = bankAccountRepository.findById("4294d7d8-8562-4acb-945e-f07399dfb07e").orElse(null);
            if(bankAccount!=null) {
                System.out.println("**************************");
